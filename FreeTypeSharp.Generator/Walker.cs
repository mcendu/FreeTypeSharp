    ...
    public static class Walker
    {
                ...
                result = result.Append(
                    StructDeclaration(
                        ...
                        new SyntaxList<MemberDeclarationSyntax>(
                            FieldDeclaration(
                                VariableDeclaration(translateFieldType(arrayType.Type, field, nestLevel))
        ...
        private static StructDeclarationSyntax translateStruct(Class @class, string name)
            => StructDeclaration(
                        ...
                        Attribute(
                            ...
                            AttributeArgumentList().AddArguments(
                                AttributeArgument(MemberAccessExpression(
                                    ...
                                    IdentifierName(@class.IsUnion ? "Explicit" : "Sequential"))))))
                }),
                new SyntaxTokenList(
                ...
                default,
                default,
                new SyntaxList<MemberDeclarationSyntax>(@class.Fields.SelectMany((field) =>
                    new[] {
                        FieldDeclaration(
                            new SyntaxList<AttributeListSyntax>(new[]
                            {
                            ...
                            new SyntaxTokenList(Token(SyntaxKind.PublicKeyword)),
                            VariableDeclaration(translateFieldType(field.Type, field.Name))
